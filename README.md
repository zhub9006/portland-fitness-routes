...
|------|-----------|-------------------|------------|
| [routes/wildwood-trail-walk.md](routes/wildwood-trail-walk.md) | Walking | 3,379 m (Macleay→Witch's Castle); 4,594 m (Macleay→Pittock) | Old-growth forest, creek crossings, Pittock Mansion views |
...
- **Leif Erikson Drive** — 2.7 mi one way (5.4 mi out-and-back)
  ...
  - **OSM Verified:** 4,390 m one-way (~5.7 min walk)
- **NW Saint Helens Road** — 1.8 mi one way
  - Historic road connecting Washington Park to Forest Park
  - Mix of residential and park trail environments
  - **OSM Verified:** 2,896 m one-way
- **Forest Park → Downtown Walking** — ~11.4 km
  - **OSM Verified:** 11,428 m (~16.8 min walk)
...
- **Forest Park → Downtown Walking** — ~4,952 m (short) / ~12,013 m (extended)
  ...
  - **OSM Verified:** 4,952 m (~8 min walk); 12,013 m (~17 min walk)
...
- **Skyline Cycling Route** — ~7.2 mi / ~800 ft elevation
  ...
  - **OSM Verified:** ~11,622 m (~20 min bike)
- **Forest Park to Downtown** — ~10.4 mi (9,440 m to downtown / 6,544 m back)
  - Descend through Forest Park into downtown Portland (~500 ft)
  - Includes Willamette River waterfront finish
  - **OSM Verified:** 9,440 m (to downtown / ~28 min); 6,544 m (from downtown / ~22 min)
- **Saltzman Warmup Loop** — ~2.9 mi / ~300 ft elevation
  - Tight, fast loop near the north entrance
  - Great for speed work and track-style intervals
  - **OSM Verified:** 4,586 m (~4 min bike on St. Helens segment)
- **Ridge Loop** — ~2.9 mi / ~500 ft elevation
  - Germantown Road → Kaiser Road → Laidlaw Road circuit
  - **OSM Verified:** 4,586 m (~7 min bike)
- **St. Johns Connector** — ~9.2 mi
  - St. Johns Bridge descent into Forest Park
  - **OSM Verified:** 14,749 m (~22 min bike)
- **St. Johns Bridge Cycling (Detailed)** — ~14.7 mi one way
  ...
  - **OSM Verified:** 14,746 m (~22 min bike)
...
- **Wildwood Trail Route 1 (Lower Macleay → Witch's Castle)** — ~2.3 mi / ~500 ft elevation
  - Lower Macleay Trail through old-growth forest to the Stone House ruins
  - Seasonal creek crossings, moderate climb
...
- **OSM Data:** All routes maintained with OpenStreetMap path and road verification
