...
A collection of walking, running, and cycling routes around Portland, Oregon — curated for our running club.
...
| # | Route Name | Type | Distance | Difficulty |
|---|-----------|------|----------|------------|
| 1 | [Forest Park Loop](forest-park-loop.md) | Running / Walking | ~2.8 km (1.7 mi) | Easy-Moderate |
| 2 | [Forest Park to Cathedral Park](forest-park-to-cathedral-park.md) | Cycling / Running | ~3.2 km (2.0 mi) | Moderate |
...
Browse the route files for details including distance, elevation, surface type, and turn-by-turn directions.

## Contributing

Want to add a route? Open a pull request or issue!